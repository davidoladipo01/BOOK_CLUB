...
import personSitting from '../assets/person-sitting-looking-at-phone.webp'
...
const rowTwo = [
    { type: "person", src: personSitting, alt: 'Person sitting with phone' },
    { type: "person", src: person1, alt: 'Person 1' },
    { type: "person", src: person2, alt: 'Person 2' },
    { type: "person", src: person3, alt: 'Person 3' },
    { type: "person", src: rt1, alt: 'RT 1' },
    { type: "person", src: rt2, alt: 'RT 2' },
    { type: "person", src: rt3, alt: 'RT 3' },
    { type: "person", src: rt4, alt: 'RT 4' },
    { type: "person", src: rt5, alt: 'RT 5' },
    { type: "person", src: rt6, alt: 'RT 6' },
    { type: "person", src: rt7, alt: 'RT 7' },
    { type: "person", src: rt8, alt: 'RT 8' },
    { type: "person", src: rt9, alt: 'RT 9' },
    { type: "person", src: rt10Jpg, alt: 'RT 10 JPG' },
    { type: "person", src: rt10Png, alt: 'RT 10 PNG' },
    { type: "person", src: rt11, alt: 'RT 11' },
    { type: "person", src: rt12, alt: 'RT 12' },
    { type: "person", src: rt13, alt: 'RT 13' },
    { type: "person", src: rt14, alt: 'RT 14' },
    { type: "person", src: rt15, alt: 'RT 15' },
    { type: "person", src: rt16, alt: 'RT 16' },
    { type: "person", src: rt17, alt: 'RT 17' },
    { type: "person", src: rt19, alt: 'RT 19' },
]
